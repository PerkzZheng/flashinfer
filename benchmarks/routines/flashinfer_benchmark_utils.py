...
output_column_dict = {
    ...
    "attention": [
        ...
        "prims_ts_source",
        "prims_ts_profile",
        "prims_ts_logical_num_heads_q",
        "prims_ts_logical_seq_len_q",
        "prims_ts_total_q_rows",
        "prims_ts_num_q_tiles",
        "prims_ts_tail_q_rows",
        "prims_ts_tile_size_q",
        "prims_ts_tile_size_kv",
        "prims_ts_num_insts_kv",
        "prims_ts_split_kv",
        "prims_ts_num_ctas_per_head_dim",
        "prims_ts_head_dim_per_cta_v",
        "prims_ts_producer_ctas",
        "prims_ts_use_cluster_reduction",
        "prims_ts_use_persistent_scheduler",
