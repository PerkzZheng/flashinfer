...
class ArtifactPath:
    ...
    TRTLLM_GEN_FMHA: str = "c12e684c0027f8803d237a1291a87332008c272faf77bed034f33df32b40fcc3/fmha/trtllm-gen/"
    TRTLLM_GEN_BMM: str = (
...
class CheckSumHash:
    ...
    TRTLLM_GEN_FMHA: str = (
        "2e9d058518cbac14c253c64c47e0464929f04fe714ac1ae94734091fd184962a"
    )
    TRTLLM_GEN_BMM: str = (
